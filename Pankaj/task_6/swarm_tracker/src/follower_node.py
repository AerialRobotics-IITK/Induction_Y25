...
class FollowerNode(Node):
    def __init__(self):
        ...
        # --- FIXED FOR OLDER OPENCV VERSIONS ---
        self.aruco_dict = aruco.getPredefinedDictionary(aruco.DICT_4X4_50)
        self.aruco_params = aruco.DetectorParameters_create() # Use legacy initialization method
        # --------------------------------------
    ...
    def image_callback(self, msg):
        ...
        # --- FIXED FOR OLDER OPENCV VERSIONS ---
        # Detect ArUco markers using module-level functions
        ...
        if ids is not None:
            ...
            for i in range(len(ids)):
                # --- FIXED FOR OLDER OPENCV VERSIONS ---
                # drawFrameAxes doesn't exist in older cv2; use drawAxis
